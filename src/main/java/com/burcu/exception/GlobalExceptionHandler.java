...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> tryMeAppHandler(TryMeAppException tryMeAppException){
        return new ResponseEntity<>(createErrorMessage(tryMeAppException,tryMeAppException.getErrorType()),
                tryMeAppException.getErrorType().getHttpStatus());
    }
    ...
    public final ResponseEntity<ErrorMessage> handleMethodArgumentNotValidException(
        ...
        ErrorType errorType = ErrorType.BAD_REEQUEST_ERROR;
